    ...
    CHANGE_TYPE(
            ...
            new MetadataConverter() {
                ...
                public Object read(SourceRecord record) {
                    ...
                    if (AbstractSourceInfo.CHANGE_TYPE_CREATE.equals(type)) {
                        type = AbstractSourceInfo.CHANGE_TYPE_INSERT;
                    } else if (AbstractSourceInfo.CHANGE_TYPE_READ.equals(type)) {
                        type = AbstractSourceInfo.CHANGE_TYPE_INIT;
                    }
                    return StringData.fromString(type);
                }
            });
